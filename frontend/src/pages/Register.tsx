...
export default function Register() {
  ...
  const [showConfirmPassword, setShowConfirmPassword] = useState(false); // State hiển thị Xác nhận mật khẩu
  ...
  const handleRegister = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    // Logic kiểm tra Mật khẩu có khớp không
  ...
  return (
    <div className="min-h-screen bg-[#FDFBF9] flex flex-col items-center justify-center p-4 font-sans py-12">
      <div className="w-full max-w-[440px] bg-white rounded-[2.5rem] p-10 shadow-sm border border-gray-100 flex flex-col items-center">
        ...
        <h1 className="text-2xl font-bold text-gray-900 mb-2">Create your vault</h1>
        <p className="text-sm text-gray-500 mb-8">Start your journey to mastery.</p>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="••••••••"
                className="w-full pl-12 pr-12 py-3.5 bg-white border border-gray-200 rounded-xl text-sm focus:outline-none focus:border-[#A82B2B] focus:ring-1 focus:ring-[#A82B2B] transition-all placeholder:text-gray-400 text-gray-800 tracking-widest"
                required
              />
              <button
                type="button"
          ...
          <div className="flex items-start pt-1">
            <div className="flex items-center h-5">
              <input
                ...
                className="w-4 h-4 border border-gray-300 rounded bg-white accent-[#A82B2B] cursor-pointer"
              />
            </div>
            <label htmlFor="terms" className="ml-2 text-xs text-gray-600 cursor-pointer">
              I agree to the <a href="#" className="text-[#A82B2B] font-bold hover:underline">Terms and Conditions</a>
            </label>
          </div>
        ...
        <div className="mt-8 text-sm text-gray-600">
          ...
          <Link to="/login" className="text-[#A82B2B] hover:text-[#8b2323] font-bold">
            Sign In
          </Link>
        </div>
      </div>
